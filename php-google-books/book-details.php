        ...
        <div class="container">
            ...
            <div class="col-md-12">
                ...
                <form name="form1" id="form1" method="post" action="results.php">
                        <input type="text" name="buscar" class="" style="display:none;">
                </form>    
                <!--
                results.php?keword=<?php //echo $_GET['keyword']?>&pagina=<?php //echo $_GET['pagina'] ?>
                -->
                <nav aria-label="breadcrumb" role="navigation" class="pull-left">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php"><i class="icon-home fa"></i></a></li>
                        <li class="breadcrumb-item breadcrumb-item-book"><a href="#">Books</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Search Results</li>
                    </ol>
                </nav>


                <div class="pull-right backtolist"><a href="#" class="breadcrumb-item-book"> <i class="fa fa-angle-double-left"></i> Back to Results</a></div>
                ...
                <div class="col-md-9 page-content col-thin-right">
                    <div class="inner inner-box ads-details-wrapper">
                        <h1 class="auto-heading"><span
                                class="auto-title left"><?php echo isset($book->volumeInfo->title) ? $book->volumeInfo->title : "No title"  ?></span> <span
                                class="auto-price pull-right"> <?php echo isset($book->saleInfo->listPrice->amount) ? "$ ".$book->saleInfo->listPrice->amount : "No price"; ?></span></h1>

                        <div style="clear:both;"></div>
                        
                        <span class="info-row"> <span class="date"><?php echo isset($book->volumeInfo->subtitle) ? $book->volumeInfo->subtitle : ""  ?></span></span>
                        ...
                        <div class="row ">
                            ...
                            <div class="item-slider">
                                    <ul class="bxslider">
                                        <li><img src="<?php echo isset($book->volumeInfo->imageLinks->thumbnail) ? $book->volumeInfo->imageLinks->thumbnail : "No image"; ?>" alt="img"/></li>
                                        <!--
                                        <li><img src="images/house/4.jpeg" alt="img"/></li>
                                        <li><img src="images/house/11.jpeg" alt="img"/></li>
                                        <li><img src="images/house/14.jpeg" alt="img"/></li>
                                        <li><img src="images/house/b12.jpg" alt="img"/></li>
                                        <li><img src="images/house/13.jpeg" alt="img"/></li>
                                        <li><img src="images/house/14.jpeg" alt="img"/></li>
                                        -->
                                    </ul>
                                    ...
                                    <div class="product-view-thumb-wrapper">
                                        ...
                                        <ul id="bx-pager" class="product-view-thumb">
                                            <li><a  data-slide-index="0" class="thumb-item-link"  href=""><img
                                                    src="<?php echo isset($book->volumeInfo->imageLinks->thumbnail) ? $book->volumeInfo->imageLinks->thumbnail : "No thumbnail"  ?>" alt="img"/></a></li>
                                            <!--
                                            <li  ><a data-slide-index="1" class="thumb-item-link" href=""><img
                                                    src="images/house/thumb/4.jpeg" alt="img"/></a></li>
                                            <li ><a data-slide-index="2" class="thumb-item-link"  href=""><img
                                                    src="images/house/thumb/11.jpeg" alt="img"/></a></li>
                                            <li ><a data-slide-index="3" class="thumb-item-link"  href=""><img
                                                    src="images/house/thumb/14.jpeg" alt="img"/></a></li>
                                            <li  ><a data-slide-index="4" class="thumb-item-link" href=""><img
                                                    src="images/house/thumb/b12.jpg" alt="img"/></a></li>
                                ...
                                <div class="col-md-4 center" style="text-align:center">
                                    <a href="book-viewer.php?pagina=<?php echo $_GET['pagina'] ?>&detail=true&id=<?php echo $_GET['id'] ?>&keyword=<?php echo $_GET['keyword'] ?>" class="btn btn-danger btn-block"><i class=" icon-link"></i> View Details </a>
                                </div>
                                    ...
                                    <div class="key-features">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <span class="media-heading"><?php echo isset($book->volumeInfo->industryIdentifiers[0]->identifier) ? $book->volumeInfo->industryIdentifiers[0]->identifier  :  "No identifier" ?></span>
                                                <span class="data-type">ISBN</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <span class="media-heading"><?php echo isset($book->volumeInfo->pageCount) ? $book->volumeInfo->pageCount : "No page count" ?></span>
                                                <span class="data-type">Pages</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <span class="media-heading"><?php echo isset($book->volumeInfo->dimensions->height) ? $book->volumeInfo->dimensions->height : "No height" ?></span>
                                                <span class="data-type">Height</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <span class="media-heading"><?php echo isset($book->volumeInfo->dimensions->width) ? $book->volumeInfo->dimensions->width : "No width" ?></span>
                                                <span class="data-type">Width</span>
                                            </div>
                                        </div>

                                        <div class="media">
                                            <div class="media-body">
                                                <span class="media-heading"><?php echo isset($book->volumeInfo->categories[0]) ? $book->volumeInfo->categories[0] :"No main category" ?></span>
                                                <span class="data-type">Main Category</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="media">
                                            <div class="media-body">
                                                <span class="media-heading"><?php echo isset($book->volumeInfo->publisher) ? $book->volumeInfo->publisher : "No publisher"  ?></span>
                                                <span class="data-type"> Publisher</span>
                                            </div>
                                        </div>

                                        <div class="media">
                                            <div class="media-body">
                                                <span class="media-heading"><?php echo isset($book->volumeInfo->publishedDate) ? $book->volumeInfo->publishedDate : "No published date"  ?></span>
                                                <span class="data-type"> Publisher Date</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="media">
                                            <div class="media-body">
                                                <span class="media-heading"><?php echo isset($book->volumeInfo->authors[0]) ? $book->volumeInfo->authors[0] : "No authors"  ?></span>
                                                <span class="data-type"> Authors</span>
                                            </div>
                                        </div>
                        ...
                        <div class="Ads-Details">
                            <h5 class="list-title"><strong>Book Details</strong></h5>

                            <div class="row">
                                <div class="ads-details-info col-md-8">
                                    <p>
                                    <?php echo isset($book->volumeInfo->description) ? $book->volumeInfo->description : "No description"; ?>
                                    </p>
                                    
                                    <h4 class="text-uppercase">Book download access</h4>

                                    <ul class="list-circle">

                                        <li><?php echo isset($book->accessInfo->downloadAccess->kind) ? $book->accessInfo->downloadAccess->kind : "No kind" ?></li>
                                        <li><?php echo isset($book->accessInfo->downloadAccess->volumeId) ? $book->accessInfo->downloadAccess->volumeId : "No volume id" ?></li>
                                        <li><?php echo isset($book->accessInfo->downloadAccess->restricted) ? $book->accessInfo->downloadAccess->restricted : "No restricted" ?></li>
                                        <li><?php echo isset($book->accessInfo->downloadAccess->deviceAllowed) ? $book->accessInfo->downloadAccess->deviceAllowed : "No device allowed" ?></li>
                                        <li><?php echo isset($book->accessInfo->downloadAccess->justAcquired) ? $book->accessInfo->downloadAccess->justAcquired : "No just acquired" ?></li>
                                        <li><?php echo isset($book->accessInfo->downloadAccess->maxDownloadDevices) ? $book->accessInfo->downloadAccess->maxDownloadDevices : "No max download" ?></li>
                                        <li><?php echo isset($book->accessInfo->downloadAccess->source) ? $book->accessInfo->downloadAccess->source : "No source" ?></li>
                                        
                                    </ul>

                                    <h4 class="text-uppercase">Book info PDF </h4>
                                    
                                    <ul class="list-circle">
                                        <li><?php echo isset($book->accessInfo->pdf->isAvailable) ? "Available" : "No available" ?></li>
                                        <li><?php echo isset($book->accessInfo->pdf->downloadLink) ? $book->accessInfo->pdf->downloadLink : "No download link" ?></li>
                                        <li><?php echo isset($book->accessInfo->pdf->acsTokenLink) ? $book->accessInfo->pdf->acsTokenLink : "No acsTokenLink" ?></li>
                                ...
                                <div class="col-md-4">
                                    <aside class="panel panel-body panel-details">
                                        <ul>
                                            <li>
                                                <p class=" no-margin "><strong>Prices:</strong><?php echo isset($book->saleInfo->listPrice->amount) ? "$ ".$book->saleInfo->listPrice->amount : "No price"; ?> </p>
                                            </li>

                                            <li>
                                                <p class="no-margin"><strong>Print Type:</strong> <?php echo $book->volumeInfo->printType; ?></p>
                                            </li>
                                            <li>
                                                <p class="no-margin"><strong>Ebook:</strong> <?php echo isset($book->saleInfo->isEbook) ? "true" : "false" ?></p>
                                            </li>

                                            <li>
                                                <p class="no-margin"><strong>Location:</strong> <?php echo isset($book->saleInfo->country) ? $book->saleInfo->country : "No info country"; ?> </p>
                                            </li>
                                            <li>
                                                <p class=" no-margin "><strong>Best Language:</strong> <?php echo isset($book->volumeInfo->language) ? $book->volumeInfo->language : "No best language"; ?></p>
                                            </li>
                                            <li>
                                                <p class="no-margin"><strong>Tickness of this volume(in cm):</strong> <?php echo isset($book->volumeInfo->dimensions->tickness) ? $book->volumeInfo->dimensions->tickness : "No tickness dimensions"; ?> </p>
                                            </li>
                                            <li>
                                                <p class="no-margin"><strong>Page count:</strong> <?php echo $book->volumeInfo->pageCount ;?>
                                                </p>
                                            </li>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".breadcrumb-item-book").click(function(){
            var buscar  = "<?php echo $_GET['keyword'];?>";
            var pagina = "<?php echo $_GET['pagina'];?>";
            $("#form1 input[name='buscar']").val(buscar);
            $("#form1").submit();
        });
